                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 p-6 sm:p-8 items-center">
                  ...
                  <div className="lg:col-span-5 space-y-3">
                    ...
                    <div className="grid grid-cols-3 gap-2 pt-2 text-xs">
                      <div className="bg-white/5 p-2.5 rounded-xl border border-white/10">
                        ...
                        <span className="font-bold text-mint-400 text-sm">${trip.totalBudget}</span>
                      </div>
                      <div className="bg-white/5 p-2.5 rounded-xl border border-white/10">
                        <span className="text-[10px] text-slate-400 block flex items-center gap-1">
                          <Plane className="w-3 h-3 text-slate-400" /> טיסות
                        </span>
                        <span className="font-semibold text-white text-xs">${trip.flightEst}</span>
                      </div>
                      <div className="bg-white/5 p-2.5 rounded-xl border border-white/10">
                        <span className="text-[10px] text-slate-400 block flex items-center gap-1">
                          <Building2 className="w-3 h-3 text-slate-400" /> מלונות
                        </span>
                        <span className="font-semibold text-white text-xs">${trip.hotelEst}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="lg:col-span-3 flex flex-col gap-3 justify-center">
                    <button
                      ...
                      className="btn-mint w-full py-3 rounded-2xl text-xs font-bold flex items-center justify-center gap-2 shadow-lg group"
                    >
                    ...
                    <button
                      ...
                      className="w-full py-2.5 rounded-2xl bg-white/5 hover:bg-white/10 border border-white/10 text-xs font-semibold text-slate-300 flex items-center justify-center gap-2 transition"
                    >
